...
interest_rate = float(raw_input("Enter the annual credit card interest as a decimal: "))
...
while True:
    ...
    if (high_payment - low_payment < 0.005):
        ...
        print "Monthly payment to pay off debt in 1 yeear: ", round(monthly_payment,2)
